...
<header class="main-header slider-on" id="top">
    <div class="main-slider-container"><!-- /contenedor-slider -->
        <div class="main-slider" ><!-- /slider-principal -->
            <ul class="scrollme"><!--Slides-->
                <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                    <img class="rs-parallaxlevel-1" src="img/slider-images/slider-bg1.jpg" alt="Acordes"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                    ...
                    <div class="tp-caption customin customout rs-parallaxlevel-2"
                        ...
                        <a href="#" class="custom-button button-style1 animateme"
                           ...
                           data-to="0.6"
                           data-opacity="0"
                           data-translatey="60"><i class="icon-eye"></i>Ver Detalles</a>
                    </div>
                </li>
